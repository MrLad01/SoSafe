...
const ZoneFileUploader: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl hover:scale-90 bg-white rounded-lg shadow-md">
      <div className="p-6 border-b border-gray-200">
        <h2 className="text-xl font-semibold text-gray-800">Upload Excel File for Zone</h2>
      </div>
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-center w-full">
          <label className="w-full flex flex-col items-center px-4 py-6 bg-white rounded-lg border-2 border-dashed border-gray-300 cursor-pointer hover:bg-gray-50">
            ...
            <div className="flex flex-col items-center">
              <span className="font-medium text-gray-600">Drop files to upload zone</span>
        ...
        <button
          ...
          type="button"
        >
          {uploading ? 'Uploading zone...' : 'Upload Zone'}
        </button>
...
export default ZoneFileUploader;